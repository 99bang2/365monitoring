...
import StatusRenderer from '../components/ag-grid/StatusRenderer'
import ActionRenderer from '../components/ag-grid/ActionRenderer'
import InvoiceNumberRenderer from '../components/ag-grid/InvoiceNumberRenderer'
import ProductsRenderer from '../components/ag-grid/ProductsRenderer'
import BoxCountRenderer from '../components/ag-grid/BoxCountRenderer'
import HubRenderer from '../components/ag-grid/HubRenderer'
	...
	data() {
		return {
			frameworkComponents: {
				...
				boxCountRenderer: BoxCountRenderer,
				hubRenderer: HubRenderer,
			},
